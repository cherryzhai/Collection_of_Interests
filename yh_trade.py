...
#            break
    ...
    latest_df = get_latest_data(code_list=stock_code_list)
    print('最新股票数据：\n', latest_df, '\n')
    ...
    if sell_stock_list and if_trade:
        ...
        for stock_code in sell_stock_list:
            ...
            order_info = user.sell(stock_code[2:], order_price, amount)
    ...
    if buy_stock_list and if_trade:
        ...
        for stock_code in buy_stock_list:
            ...
            if buy_amount >= 100:
                # 下单
                order_info = user.buy(stock_code[2:], order_price, buy_amount)
